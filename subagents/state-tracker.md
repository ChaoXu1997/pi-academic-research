...
> Ported from upstream `academic-pipeline/agents/state_tracker_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
