...
> Ported from upstream `deep-research/agents/editor_in_chief_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
