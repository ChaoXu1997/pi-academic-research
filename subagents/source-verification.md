...
> Ported from upstream `deep-research/agents/source_verification_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
