...
> Ported from upstream `academic-pipeline/agents/integrity_verification_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
