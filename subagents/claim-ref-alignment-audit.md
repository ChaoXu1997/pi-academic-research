---
name: claim-ref-alignment-audit
...
> Ported from upstream `academic-pipeline/agents/claim_ref_alignment_audit_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
