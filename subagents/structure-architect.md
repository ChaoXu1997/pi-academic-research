...
> Ported from upstream `academic-paper/agents/structure_architect_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
