...
> Ported from upstream `deep-research/agents/devils_advocate_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
