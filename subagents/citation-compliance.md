...
> Ported from upstream `academic-paper/agents/citation_compliance_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
