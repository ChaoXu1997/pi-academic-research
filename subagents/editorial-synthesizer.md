...
> Ported from upstream `academic-paper-reviewer/agents/editorial_synthesizer_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
