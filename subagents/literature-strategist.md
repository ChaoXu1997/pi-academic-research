...
> Ported from upstream `academic-paper/agents/literature_strategist_agent.md` (Claude Code agent). Adapted to Pi subagent format by the `pi-academic-research` package.
